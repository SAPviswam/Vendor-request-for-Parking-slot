		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Parking slot reservations",
									"targetURL": "#comappvendoreservations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappvendoreservations-display": {
								"semanticObject": "comappvendoreservations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.vendoreservations",
									"url": sap.ui.require.toUrl("com/app/vendoreservations")
								}
							}
						}
					}
